...
const SettingsDropdown = ({ open, setOpen, onShowConsentModal }: SettingsDropdownProps) => {
    ...
    return (
        <div className="relative" ref={dropdownRef}>
            <div className="border-black-30 absolute top-full right-0 z-50 mt-2 flex h-[431px] w-[320px] flex-col justify-center rounded-[10px] border border-[0.5px] bg-white p-6 shadow-[-4px_4px_8px_0px_rgba(0,0,0,0.15)]">
