...
const InitialPage = () => {
    ...
    return (
        <div className="relative h-screen w-full overflow-hidden bg-white">
            {/* 배경 블러 효과 박스 */}
            <div className="absolute top-[232px] left-0 h-[560px] w-[1440px] border-t-[3px] border-b-[3px] border-[#0557E0] shadow-[30px_30px_30px_rgba(0,0,0,0.1)] blur-[15px]" />

            {/* 메인 컨텐츠 */}
            <div className="relative flex h-full justify-center pt-20">
                <div className="flex items-start gap-[120px]">
                    ...
                    {/* 세로선 */}
                    <div className="mt-8 h-[400px] w-px bg-black/10" />
